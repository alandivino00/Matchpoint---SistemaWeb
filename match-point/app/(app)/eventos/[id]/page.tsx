...
export default function EventoDetalhePage({
  ...
  if (!event) {
    return <div className="text-[#09054A]">Evento não encontrado.</div>;
  }
  ...
  return (
    <section className="space-y-6">
      <Link href="/eventos" className="font-semibold text-[#09054A]">
        ← Voltar
      </Link>
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <article className="rounded-2xl bg-[#09054A] p-6 text-[#FFAA00] lg:col-span-1">
          ...
          <div className="mt-8 space-y-4 text-sm">
            ...
            <p>
              <strong>Máximo de jogadores:</strong> {event.confirmados}/
              {event.maxJogadores}
            </p>
          </div>
      ...
      <div className="rounded-2xl bg-[#09054A] p-6 text-[#FFAA00]">
        ...
        <button
          type="button"
          className="mt-6 rounded-xl bg-[#FFAA00] px-6 py-3 font-bold text-[#09054A]"
        >
          Confirmar presença
        </button>
      </div>
