        ...
        <section className="mx-auto w-full max-w-[560px]">
          ...
          <form className="space-y-4">
            <div>
              ...
              <input className="w-full rounded-lg border border-[#1D2A8A] p-3 outline-none" placeholder="seu@email.com" />
            </div>

            <div>
              <label className="mb-2 block text-sm font-semibold text-[#09054A]">Senha</label>
              <input type="password" className="w-full rounded-lg border border-[#1D2A8A] p-3 outline-none" placeholder="••••••••••••" />
            </div>

            <button className="w-full rounded-lg bg-[#09054A] py-3 font-semibold text-white">
              Entrar
            </button>

            <button type="button" className="w-full rounded-lg border border-[#1D2A8A] py-3 font-semibold text-[#09054A]">
              Cadastrar-se
            </button>
          </form>
        </section>
